...
async function notifyProviderDisabled(
  ...
  await octokit.rest.issues.createComment({
    ...
    repo,
    issue_number,
    body: `**${name}** is not currently available. [Current providers](https://github.com/${owner}/.github/blob/main/.github/.github-bot-ai-reviewed-prs.yml) are: ${[...config.providers].join(", ") || "<none>"}.`,
  });
}
