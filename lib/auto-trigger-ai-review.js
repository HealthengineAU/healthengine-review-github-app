...
export function isAutoReviewEligible({ aiReview, repo, pr }) {
  ...
  if (pr.draft && !aiReview.draft) return false;
...
export function register(app) {
  app.on([
    ...
    // skips them. Drafts are a config decision (ai_review.draft), checked in
    // isAutoReviewEligible; by default they get their invite once ready.
