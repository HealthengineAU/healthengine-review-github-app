...
// Unlinked: the thread below carries the link to the tracker, and an unfurled
// issue link in the channel message is a preview nobody reads.
export function triageText({ key, summary }) {
  return `*${key} raised* - ${summary} — Reply in thread :thread:`;
}
