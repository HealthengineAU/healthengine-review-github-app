...
export function incidentModal({ responseUrl, text, origin, incidents } = {}) {
  ...
  const destinations = [
    ...
    option("dedicated", "New private channel", "Incident will be codenamed (e.g. incy-1234-wintery-snowfall)"),
  ];
  ...
  return {
    ...
    title: { type: "plain_text", text: "Raise incident" },
    submit: { type: "plain_text", text: "Raise" },
        ...
        ? [
            {
              ...
              elements: [
                {
                  type: "mrkdwn",
                  text: `To create in <#${origin.id}>, add @Incy to the channel`,
                },
              ],
            },
          ]
